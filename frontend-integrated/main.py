...
_DEFAULT_PROFILE = _UserProfile(
    ...
    locations_preferred=["india", "remote", "bangalore", "chennai",
...
async def get_new_jobs_endpoint(
    ...
    from database.db import get_new_jobs as db_new_jobs
    keywords = [
        "software engineer", "ml engineer", "intern", "python",
        "machine learning", "backend", "data scientist",
    ]
    jobs = db_new_jobs(keywords, since_hours)
    job_list = [dict(j) for j in jobs[:limit]]
